...
- 迭代记录：**每完成一轮功能迭代，在 `docs/改良计划/` 下按日期新建 md 记录**（如 `2026-09-13.md`），写明本轮做了什么 / 修了什么 / 清理了什么 / 遗留什么（模板见已有的 2026-09-13.md）；`docs/初始模块建立草图/implementation.md` 只承载里程碑 1-9 的基础搭建阶段，此后不再追加
